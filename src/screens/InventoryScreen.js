          ...
          <div style={styles.sectionActions}>
            <button 
              style={{
                ...
                backgroundColor: clickedButtons['addItem'] ? '#ffffff' : '#0ea5e9',
                color: clickedButtons['addItem'] ? '#0ea5e9' : '#ffffff',
                border: clickedButtons['addItem'] ? '2px solid #0ea5e9' : 'none',
              }}
            ...
            <button 
              style={{
                ...
                backgroundColor: clickedButtons['addCategory'] ? '#ffffff' : '#0ea5e9',
                color: clickedButtons['addCategory'] ? '#0ea5e9' : '#ffffff',
                border: clickedButtons['addCategory'] ? '2px solid #0ea5e9' : 'none',
              }}
              onClick={() => handleButtonClick('addCategory', () => { setEditingCategory(null); setNewCategoryName(''); setShowCategoryModal(true); })}
            >
              Add Category
            </button>
          </div>
        ...
        <div style={styles.modalButtons}>
          {isEdit && (
            <button 
              style={{
                ...styles.deleteButton,
                backgroundColor: clickedButtons['modalDelete'] ? '#ffffff' : '#ef4444',
                color: clickedButtons['modalDelete'] ? '#ef4444' : '#ffffff',
                border: clickedButtons['modalDelete'] ? '2px solid #ef4444' : 'none',
              }}
              onClick={() => handleButtonClick('modalDelete', onDelete)}
            >
              Delete
            </button>
          )}
          <button 
            style={{
              ...styles.cancelButton,
              backgroundColor: clickedButtons['modalCancel'] ? '#ffffff' : '#f1f5f9',
              color: clickedButtons['modalCancel'] ? '#475569' : '#475569',
              border: clickedButtons['modalCancel'] ? '2px solid #d1d5db' : '1px solid #e2e8f0',
            }}
            onClick={() => handleButtonClick('modalCancel', onClose)}
          >
            Cancel
          </button>
          <button 
            style={{
              ...styles.submitButton,
              backgroundColor: clickedButtons['modalSubmit'] ? '#ffffff' : '#0ea5e9',
              color: clickedButtons['modalSubmit'] ? '#0ea5e9' : '#ffffff',
              border: clickedButtons['modalSubmit'] ? '2px solid #0ea5e9' : 'none',
            }}
            onClick={() => handleButtonClick('modalSubmit', onSubmit)}
          >
...
function CategoryModal({ visible, onClose, newCategoryName, setNewCategoryName, onSubmit, editingCategory, onDelete, categories, handleEditCategory, clickedButtons, handleButtonClick }) {
  if (!visible) return null;
  return (
    <div style={styles.modalOverlay}>
      <div style={styles.modalContainer}>
                    ...
                    <tr key={c.category_id} style={styles.tableRow}>
                      ...
                      <td style={styles.tableCell}>
                        <button 
                          style={{
                            ...styles.editButton,
                            backgroundColor: clickedButtons[`categoryEdit-${c.category_id}`] ? '#ffffff' : '#0ea5e9',
                            color: clickedButtons[`categoryEdit-${c.category_id}`] ? '#0ea5e9' : '#ffffff',
                            border: clickedButtons[`categoryEdit-${c.category_id}`] ? '2px solid #0ea5e9' : 'none',
                          }}
                          onClick={() => handleButtonClick(`categoryEdit-${c.category_id}`, () => handleEditCategory(c))}
                        >
                          Edit
                        </button>
                      </td>
        ...
        <div style={styles.modalButtons}>
          {editingCategory && (
            <button 
              style={{
                ...styles.deleteButton,
                backgroundColor: clickedButtons['categoryDelete'] ? '#ffffff' : '#ef4444',
                color: clickedButtons['categoryDelete'] ? '#ef4444' : '#ffffff',
                border: clickedButtons['categoryDelete'] ? '2px solid #ef4444' : 'none',
              }}
              onClick={() => handleButtonClick('categoryDelete', () => onDelete(editingCategory))}
            >
              Delete
            </button>
          )}
          <button 
            style={{
              ...styles.cancelButton,
              backgroundColor: clickedButtons['categoryCancel'] ? '#ffffff' : '#f1f5f9',
              color: clickedButtons['categoryCancel'] ? '#475569' : '#475569',
              border: clickedButtons['categoryCancel'] ? '2px solid #d1d5db' : '1px solid #e2e8f0',
            }}
            onClick={() => handleButtonClick('categoryCancel', onClose)}
          >
            Cancel
          </button>
          <button 
            style={{
              ...styles.submitButton,
              backgroundColor: clickedButtons['categorySubmit'] ? '#ffffff' : '#0ea5e9',
              color: clickedButtons['categorySubmit'] ? '#0ea5e9' : '#ffffff',
              border: clickedButtons['categorySubmit'] ? '2px solid #0ea5e9' : 'none',
            }}
            onClick={() => handleButtonClick('categorySubmit', onSubmit)}
          >
